const { VAR_PREFIX, END_OF_IMPORT_IDENTIFICATION, END_OF_FILE_IDENTIFICATION } = require("./contants");
...
function vilexPlugin() {
  ...
  function transform(code, id) {
    ...
    const tfc = TransformCode(code, id, VAR_PREFIX, END_OF_IMPORT_IDENTIFICATION, END_OF_FILE_IDENTIFICATION)
    ...
    const result =  generate(parse(code, {
      plugins: ['typescript'],
      sourceType: 'module'
    }))
